...
class Params:
    def __init__(self):
        ...
        self.swing_height = 0.03
        self.running_stride = 0.1
        self.max_turn_stride = 0.07
        self.smallest_period = 1.0
...
class StateMachineController(Node):
    ...
    def cmd_vel_callback(self, msg: Twist):
        ...
        # self.get_logger().info(f"cmd_vel: {self.cmd_vel}")
    ...
    def params_callback(self, msg: Float32MultiArray):
        ...
        self.states[StateType.WALK].stride = 0.05 + msg.data[3]*0.15
